...
| ------ | --------------------------------------------- | ------------------------------------ | ---------------------------- |
| GET    | `/api/appointments/case-types`                | Get case types dropdown              | None                         |
| GET    | `/api/appointments/clients-dropdown/:user_id` | Get clients for appointment dropdown | `user_id` (URL param)        |
| GET    | `/api/appointments/all/:user_id`              | Get all appointments for a user      | `user_id` (URL param)        |
| GET    | `/api/appointments/:appointment_id`           | Get appointment by ID                | `appointment_id` (URL param) |
| POST   | `/api/appointments/create`                    | Create new appointment               | Request Body                 |
| PUT    | `/api/appointments/update`                    | Update appointment                   | Request Body                 |
| DELETE | `/api/appointments/delete/:appointment_id`    | Delete appointment                   | `appointment_id` (URL param) |
...
| -------------------- | ----------------------------------- |
| Total Clients        | `/api/clients/client-list/:user_id` |
| Total Cases          | `/api/cases/case-list`              |
| Total Documents      | `/api/documents/all/:user_id`       |
| Total Hearings       | `/api/hearings/all/:user_id`        |
| Today's Hearings     | `/api/hearings/all/:user_id`        |
| Today's Appointments | `/api/appointments/all/:user_id`    |
| Quick Notes          | `/api/case-notes/all/:user_id`      |
| Calendar Events      | `/api/hearings/all/:user_id`        |
...
| GET    | `/api/invoices/all/:user_id`       | Get all invoices for a user |
| GET    | `/api/invoices/:invoice_id`        | Get a single invoice by ID  |
| PUT    | `/api/invoices/update/:invoice_id` | Update an invoice           |
| POST   | `/api/invoices/payment`            | Add a payment to an invoice |
